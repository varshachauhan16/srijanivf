...
const Appointment = () => {
  ...
  const inputCls = (err?: string) =>
    ...
    ${err ? "border-red-400 focus:border-red-400" : "border-gray-200 focus:border-pink-400"}`;

  return (
    <section id="appointment" className="py-16 md:py-24 bg-gradient-to-br from-pink-50 to-rose-50">
      <div className="container mx-auto px-4 md:px-6 max-w-6xl">

        {/* Heading */}
        <div className="text-center mb-10 md:mb-14">
          <h2 className="text-3xl md:text-5xl font-bold text-pink-600">Book Appointment</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-stretch">
          ...
          {/* ── LEFT: Locations + Contact ── */}
          <div className="flex flex-col gap-4">

            {/* Location cards — 2 col on all sizes */}
          ...
          <div className="bg-white border border-pink-100 rounded-3xl p-5 md:p-8 shadow-lg flex flex-col">
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-3 md:gap-4 flex-1">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      if (/^[a-zA-Z\s]*$/.test(val)) handleChange(e);
                    }}
